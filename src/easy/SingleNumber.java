...
public class SingleNumber {
	...
	{
		Assert.assertEquals(1, getSingleNumber(new int[] {2,2,1}));
	}	

	@Test
	public void example2()
	{
		Assert.assertEquals(4, getSingleNumber(new int[] {4,1,2,1,2}));
	}
	
	@Test
	public void example3()
	{
		Assert.assertEquals(1, getSingleNumber(new int[] {1}));
	}
   /*TC O(N) SC O(1)*/
	private int getSingleNumber(int[] inputArray) {
		int output=0;
